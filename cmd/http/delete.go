...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		exeDest := "http/http-delete.js"

		if exampleFlag, _ := cmd.Flags().GetBool("example"); exampleFlag {
			exeDest = "http/http-delete.ex.js"
		}
...
func init() {
	...
	deleteCmd.Flags().BoolP("example", "x", false, "See an example output. run with --raw option to see source code.")
}
